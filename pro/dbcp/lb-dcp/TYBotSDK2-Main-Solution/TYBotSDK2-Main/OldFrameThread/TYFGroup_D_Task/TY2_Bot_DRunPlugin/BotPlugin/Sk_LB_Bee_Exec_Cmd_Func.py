    ...
    def Bee_Exec_WebCrawl( strDestURLArray, IsGlobalStopExitFunc):
        ...
        for strEachURL in strDestURLArray:
            ...
            try:
                ...
                strCrawCMDContentArray = [CSkLB_Config_RemoteClient_BaseDef.g_str_CrawURL_Cmd_Line_Sign, str(len(link_list)),
                                          strExecTime, strEachURL, str(iHTTPResponseStatus), strWebServerType, strContentType,
