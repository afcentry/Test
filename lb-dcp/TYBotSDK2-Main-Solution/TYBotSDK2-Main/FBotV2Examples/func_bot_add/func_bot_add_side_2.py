...
class FuncBotWorker:
    ...
    def protocol_state_C(self, value, param1, param2, is_last_package):
    ...
    def protocol_state_A(self, value, param1, param2, is_last_package):
    ...
    def start(self):
        ...
        bot.add_connect_to_callbacks("BrainA", 900, 901, self.protocol_state_A, True)
        bot.add_connect_to_callbacks("BrainA", 900, 902, self.protocol_state_C, False)

        bot.add_connect_to_callbacks("BrainA", 1100, 1101, self.protocol_state_A2, True)
        bot.add_connect_to_callbacks("BrainA", 1100, 1102, self.protocol_state_C2, False)
        bot.add_connect_to_callbacks("BrainA", 1100, 1104, self.protocol_state_E2, False)
        bot.run()


if __name__ == "__main__":
    funcBot = FuncBotWorker()
    funcBot.start()
