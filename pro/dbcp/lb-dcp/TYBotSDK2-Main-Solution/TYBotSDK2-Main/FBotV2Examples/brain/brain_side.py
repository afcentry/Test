...
def protocol_state_D(peerName,value, param1,param2,is_last_package):
    print("[*]Protocol State D:PeerName={0},Value={1},Param1={2},Param2={3}".format(peerName,value, param1, param2))
    sendCTUnit =FBot.make_package(904, "", "", "")
    retCTUnitArray = [sendCTUnit]
    return retCTUnitArray

def protocol_state_B2(peerName,value, param1,param2,is_last_package):
...
def protocol_state_D2(peerName,value, param1,param2,is_last_package):
    print("[*]Protocol State D2:PeerName={0},Value={1},Param1={2},Param2={3}".format(peerName,value, param1, param2))
    sendCTUnit =FBot.make_package(1104, "", "", "")
    retCTUnitArray = [sendCTUnit]
    return retCTUnitArray

def protocol_state_E2(peerName,value, param1,param2,is_last_package):
    print("[*]Protocol State E2:PeerName={0},Value={1},Param1={2},Param2={3}".format(peerName,value, param1, param2))
...
if __name__=="__main__":
    bot=FBot(listen_socks=[900,1100],listen_accpet_callback=listen_accept_callback,report_status=True,comment="任务大脑调度")
