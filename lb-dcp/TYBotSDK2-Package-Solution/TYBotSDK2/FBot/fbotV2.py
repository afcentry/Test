...
class FBot:
    ...
    def __add_report_status_sock_callbacks(self):
        ...
        def connect_request_exec_callback(value, param1, param2, is_last_package):
            ...
            sendCTUnit = FBot.make_package(OP_ACTION_BRAIN_SUB_CMD_REPLY_EXEC_RESULT, self.__node_status.dumps_json(),
                                           "", "")
    ...
    def run(self):
        ...
        # 设置默认对环境全局事件处理
        botFrameThread.SetDefaultConsoleCompatible(FBot.environment_event_handle)
        # 准备运行
